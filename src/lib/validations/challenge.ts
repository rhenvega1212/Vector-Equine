...
export const challengeStatusEnum = z.enum(["draft", "published", "active", "archived"]);
export const scheduleTypeEnum = z.enum(["scheduled", "evergreen"]);
export const nicheEnum = z.enum(["dressage", "rider", "reining", "young_horse"]);
