-- Dev apply: active horse + trainer claim + flags (mirror of 20260814000000)
...
-- Taught lesson readable on claim (extends SECURITY DEFINER helper — no session_shares recursion)
