-- Edge devices (Jetson) bound to a rider for synced video/sensor capture.
-- Master clock remains capture_sessions.t0; device stamps assets with sync_offset_ms.
...
BEGIN
  IF EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_edge_devices_updated_at ON edge_devices;
